/**
 * StateFarm Client V3 - Plain JS Version (No Userscript Manager Required)
 * Shell Shockers Aimbot & ESP
 * Version: 3.5.5
 * License: GPL-3.0
 * 
 * Load Tweakpane before this script:
 * <script src="https://cdn.jsdelivr.net/npm/tweakpane@3.1.10/dist/tweakpane.min.js"></script>
 */

// Polyfill GM_* APIs using localStorage and standard browser APIs
if (typeof GM_getValue === 'undefined') {
    ...
    window.GM_openInTab = function(url, options) {
        ...
        if (options && options.active && newWindow) {
            newWindow.focus();
        }
        return newWindow;
    };
...
// Ensure unsafeWindow exists (for non-userscript environments)

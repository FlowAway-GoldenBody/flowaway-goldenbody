...
// run this as soon as the page is ready (first line load hook)
function runFirstLineOnLoad(callback) {
...
runFirstLineOnLoad(function () {
  // This is your "first line" runtime hook.
  // Put your thing here or define `window.onFirstLineLoad` elsewhere.
  if (typeof window.onFirstLineLoad === 'function') {
    try { window.onFirstLineLoad(); } catch (e) { console.error('onFirstLineLoad error', e); }
  }
});

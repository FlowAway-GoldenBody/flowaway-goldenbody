...
let textEditor = function (path, posX = 50, posY = 50) {
...
try {
  sysScript.addEventListener('load', () => {
    for (const textEditorButton of textEditorButtons) {
    textEditorButton.addEventListener("contextmenu", textEditorContextMenu);
  }});
} catch(e) {

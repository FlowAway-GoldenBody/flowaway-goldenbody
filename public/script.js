(function () {
    document.getElementById('session-shuffling').checked = false;
    ...
    function loadSettings(session) {
        ...
        // document.getElementById('_session-shuffling').checked = typeof session.enableShuffling === 'boolean' ? session.enableShuffling : true;
    }
    ...
    window.addEventListener('load', function () {
        ...
        function go() {
            ...
            document.getElementById('session-shuffling').checked = false;
            var enableShuffling = false; //document.getElementById('session-shuffling').checked;
            ...
            api.sessionexists(id, function (value) {
                ...
                api.editsession(id, httpproxy, false, function () {
                    editSession(id, httpproxy, false);
